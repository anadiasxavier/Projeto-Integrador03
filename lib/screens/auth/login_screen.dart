...
import '../../main.dart'
    as main_app; // O as main_app cria um apelido para o main.dart. Por isso escreve main_app.nomeJogador em vez de só nomeJogador
      ...
      if (playerData != null && playerData['senha'] == _senha) {
        ...
        if (genero.isEmpty) {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => GenderSelectionScreen(ra: _ra),
            ),
          );
        } else {
          Navigator.pushReplacement(
